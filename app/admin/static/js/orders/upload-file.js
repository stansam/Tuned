class AdditionalFilesUploader {
    ...
    async uploadFiles() {
        ...
        try {
            ...
            const result = JSON.parse(response.responseText);//await response.json();
    ...
    uploadWithProgress(formData, progressBar, progressText) {
        return new Promise((resolve, reject) => {
            ...
            xhr.open('POST', `http://api.tunedessays.com:5000/admin/delivery/${orderId}/upload-additional-files`);
