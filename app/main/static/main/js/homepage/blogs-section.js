document.addEventListener('DOMContentLoaded', function() {
    ...
    async function initBlogCarousel() {
        ...
        blogPosts.forEach(post => {
            ...
            const featuredImage = post.featured_image ? `/static/uploads/${post.featured_image}` : '/static/main/main/assets/no-blog.jpeg';
            ...
            card.innerHTML = `
                ...
                <div class="blog-content">
                    ...
                    <h3 class="blog-title"><strong>${title}</strong></h3>
